        ...
        for (User sqlobj : sql){
            ...
            for (User apiobj : sql ){
                if (sqlobj.getId()!=apiobj.getId()){
                    ...
                    if (sqlobj.getSex().equals(apiobj.getSex()) && sqlobj.getFirstName().equals(apiobj.getFirstName()) &&
                            sqlobj.getSecondName().equals(apiobj.getSecondName()) && sqlobj.getAge()==apiobj.getAge() &&
